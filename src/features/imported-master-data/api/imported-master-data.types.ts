...
export type MeterCounterItem = { id: string; counterCode: string; counterName: string; equipmentCodeSnapshot: string | null; counterUnit: string; meterType: string; expectedDailyConsumption: string | null; alertDeviationPct: string | null; status: string; updatedAt: string };
